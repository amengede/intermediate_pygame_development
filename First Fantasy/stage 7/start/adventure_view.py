...
class MapView(pg.sprite.Sprite):
    ...
    def render(self,
        ...
        self.image.blit(self.images[PLAYER], player.rect)
...
class MiniMapView(pg.sprite.Sprite):
    ...
    def render(self,
        ...
        translated_rect.y *= scale_factor
        translated_rect.move_ip(cen_x, cen_y)
        self.image.blit(self.images[PLAYER], translated_rect)
...
class Renderer:
    ...
    def create_assets(self) -> None:
        ...
        self.images = {
            TERRAIN_GROUND: pg.Surface((32,32)),
            TERRAIN_RADIATED_GROUND: pg.Surface((32,32)),
            TERRAIN_BLOCKED: pg.Surface((32,32)),
            PLAYER: pg.Surface((24,24)),
            NPC: pg.Surface((24,24))
        }

        self.images[TERRAIN_GROUND].fill(TERRAIN_COLORS[TERRAIN_GROUND])
        self.images[TERRAIN_RADIATED_GROUND].fill(
            TERRAIN_COLORS[TERRAIN_RADIATED_GROUND]
        )
        self.images[TERRAIN_BLOCKED].fill(TERRAIN_COLORS[TERRAIN_BLOCKED])
        self.images[PLAYER].fill(PLAYER_COLOR)
        self.images[NPC].fill(NPC_COLOR)
