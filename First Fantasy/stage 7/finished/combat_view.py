...
class MapView(pg.sprite.Sprite):
    ...
    def create_bg_image(self) -> None:
        ...
        temp_surface = pg.image.load("gfx/wasteland.jpg").convert()
        self.bg_image = pg.transform.scale(temp_surface, (self.rect.w, self.rect.h))
...
class Renderer:
    ...
    def create_assets(self) -> None:
        ...
        temp_surface = pg.image.load("gfx/soldier_west_0.png").convert_alpha()
        self.images[SOLDIER] = pg.transform.scale(temp_surface, (32,32))
        temp_surface = pg.image.load("gfx/mage_west_0.png").convert_alpha()
        self.images[MAGE] = pg.transform.scale(temp_surface, (32,32))
        temp_surface = pg.image.load("gfx/rat.png").convert_alpha()
        self.images[RAT] = pg.transform.scale(temp_surface, (32,32))
        temp_surface = pg.image.load("gfx/cultist.png").convert_alpha()
        self.images[CULTIST] = pg.transform.scale(temp_surface, (32,32))
